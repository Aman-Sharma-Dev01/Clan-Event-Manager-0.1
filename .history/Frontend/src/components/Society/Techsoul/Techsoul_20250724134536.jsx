                    ...
                    <div className="mb-16 text-center">
                        <div className="flex justify-center mb-6">
                            <div className="h-24 w-24 rounded-full bg-primary-600 flex items-center justify-center transform hover:scale-105 transition-all duration-300 shadow-lg shadow-primary-500/30">
                                ...
                                <img src="/SocietyLogo/techsoul.jpg" alt="techsoulLogo" className="h-24 w-24 rounded-full bg-primary-600 flex items-center justify-center transform hover:scale-105 transition-all duration-300 shadow-lg shadow-primary-500/30"></img>/>
                            </div>
                        </div>
